...
class PlayerData
{
  ...
  /**
   * Text displayed in the PauseSubState for deaths when there is only 1 death
   */
  @:optional
  @:default("Blue Ball")
  public var pauseDeathNameSingle:Null<String>;
  ...
  @:optional
  @:default("Blue Balls")
  public var pauseDeathNameMultiple:Null<String>;
